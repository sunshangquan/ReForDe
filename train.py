...
parser.add_argument('--lq_path', type=str, default='../VOC_fog/train/hazy', help='Path of the low quality dataset')
parser.add_argument('--gt_path', type=str, default='../VOC_fog/train/clean', help='Path of the ground truth dataset')
parser.add_argument('--an_path', type=str, default='../VOC_fog/train/an', help='Path of the annotation dataset')
parser.add_argument('--model_res', type=str, default='GridDehaze', help='restoration type name, e.g. MSBDN')
...
parser.add_argument('--det_size', type=float, default=640, help='detection image size')
...
parser.add_argument("--train_step", type=int, default=1, help="step number for training")
...
##### log path #####
opt.log_path = opjoin('./log', opt.model_res+"_"+opt.model_det+"_att_lr7")
...
def get_attack(input_img, gt, an_file, eps=4/255., eps_iter=0.5/255., n_iter=10):
