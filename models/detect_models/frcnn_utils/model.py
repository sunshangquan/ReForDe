...
#    classes = ['bicycle', 'boat', 'bottle', 'bus', 'car', 'cat', 'chair', 'dog', 'motorbike', 'person',]
    ...
    def __init__(self, n_fg_class=5, ratios=(0.5, 1, 2), anchor_scales=(8, 16, 32)):
...
class FRCNN_VGG16_10(FasterRCNN):
    """Faster R-CNN based on VGG-16.
    For descriptions on the interface of this model, please refer to
    :class:`model.faster_rcnn.FasterRCNN`.
...
#    classes = ['person', 'car', 'bus', 'bicycle', 'motorcycle']
    ...
    def __init__(self, n_fg_class=10, ratios=(0.5, 1, 2), anchor_scales=(8, 16, 32)):
        extractor, classifier = decompose_vgg16()
        ...
        super(FRCNN_VGG16_10, self).__init__(extractor, rpn, head, )
